...
public class UserJsonTest {
	...
	public void deveVerificarListaRaiz() {
		...
		.then()
			.statusCode(200)
			.body("$", hasSize(3)) //Pode usar $ para indicar a raiz, ou simplesmente deixar em branco
	...
	public void deveFazerVerificacoesAvancadas() {
		...
		.then()
			...
			/* Nao sei porque essa linha comecou a dar erro de compilacao, entao comentei ela. Depois verifico.
